...
//!
//! CAUTION: There are no guarantees for backwards compatibility, this module should be
//! considered an internal implementation detail which can vanish without further warning. Use
//! at your own risk.
//!
