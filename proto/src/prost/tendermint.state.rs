...
pub struct AbciResponses {
    ...
    pub process_proposal: ::core::option::Option<super::abci::ResponseProcessProposal>,
...
pub struct State {
    ...
    #[prost(uint32, tag = "14")]
    pub last_core_chain_locked_block_height: u32,
    #[prost(message, optional, tag = "15")]
    pub next_core_chain_lock: ::core::option::Option<super::types::CoreChainLock>,
}
